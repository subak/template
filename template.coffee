...
class Subak.Template
  ...
  reset: ->
    ...
    if @doc.parentNode?
      @doc.parentNode.insertBefore doc, @doc
      @doc.parentNode.removeChild @doc
    else if @insertBefore? and @insertBefore.parentNode?
      @insertBefore.parentNode.insertBefore doc, @insertBefore
    else if @parentNode? and @parentNode.parentNode?
  ...
  close: ->
    ...
    for node in @blockNodes
      node.parentNode.removeChild node if node.getAttributeNode(@block)?
    ...
    for node in @veilNodes
      node.parentNode.removeChild node if node.getAttributeNode(@veil)?
